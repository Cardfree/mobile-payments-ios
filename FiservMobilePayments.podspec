Pod::Spec.new do |spec|
  ...
  spec.homepage      = 'https://github.com/Cardfree/mobile-payments-ios'
  spec.license       = { :type => 'MIT', :file => 'LICENSE' }
  spec.authors       = { 'Allan' => 'allan.cheng@fiserv.com' }
  spec.platform      = :ios, '16.4'
  spec.swift_version = '5.0'
  spec.source        = { :git => 'https://github.com/Cardfree/mobile-payments-ios/releases/download/1.0.0/FiservMobilePayments.zip' }
